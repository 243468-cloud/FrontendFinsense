...
export default function NotificationsPage() {
  ...
  return (
    <PageTransition className="min-h-screen bg-surface-2">
      {/* ─── Header ─── */}
      <header className="sticky top-0 z-20 bg-white/95 backdrop-blur-xl border-b border-border px-4 py-3.5 flex items-center justify-between">
                  ...
                  <motion.div
                    ...
                    className={`p-4 rounded-2xl border transition-all flex gap-3 relative overflow-hidden group cursor-pointer ${
                      notif.read 
                        ...
                        : 'bg-white border-primary/20 shadow-blue-sm'
                    }`}
                  >

...
import { formatCurrency, formatDate, getIconForEmoji } from '@/lib/utils';
    ...
    <PageTransition className="min-h-screen bg-surface-2 pb-24">
      ...
      <div className="p-3 sm:p-4 space-y-4 max-w-sm sm:max-w-md md:max-w-2xl lg:max-w-4xl mx-auto md:px-6 md:py-6">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="bg-white border border-border rounded-2xl p-4 sm:p-6 shadow-card space-y-4"
        >
          <div className="flex items-center justify-between">
            ...
            <span className={`font-mono font-bold text-sm px-2.5 py-0.5 rounded-full ${
              isComplete ? 'text-success bg-green-50' : 'text-primary bg-blue-50'
            }`}>
              {pct}%
            </span>
          </div>
              ...
              {avgSavingsPerDay <= 0 ? (
                ...
                <div className="space-y-2 pt-0.5">
                  ...
                  {!isComplete && projectedCompletionDate ? (
                    <div className="bg-white/80 p-2.5 rounded-xl border border-primary/10 text-xs font-dm space-y-1">
                    ...
                    <div className="bg-emerald-500/10 p-2.5 rounded-xl border border-emerald-500/20 text-xs font-dm text-emerald-800 flex items-center gap-1.5">
            ...
            <form onSubmit={handleAddDeposit} className="flex gap-2">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full bg-surface-2 border border-border rounded-xl px-3 py-2.5 font-dm text-xs sm:text-sm text-text-primary outline-none focus:bg-white focus:border-primary transition-all"
                  required
                />
              </div>
              <Button

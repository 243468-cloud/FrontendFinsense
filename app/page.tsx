...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-20 md:pt-16 md:pb-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            {/* City badge */}
            <motion.div
              className="inline-flex items-center gap-2 bg-white border border-primary/20 rounded-full px-4 py-2 shadow-blue-sm"
            ...
            >
              ...
              <p className="font-dm text-xs sm:text-sm text-text-secondary">
                <span className="font-bold text-text-primary">3,500+</span> estudiantes de la{' '}
                <span className="font-semibold text-primary">UP Chiapas</span> ya controlan su dinero.
              </p>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            ...
            >
              ...
              <div className="flex-1 flex flex-col pt-8 pb-4 px-3 gap-4 overflow-y-auto scroll-x-hidden text-white font-dm">
                ...
                {/* Balance Widget */}
                <div className="bg-gradient-to-r from-primary/20 to-accent/20 backdrop-blur-md rounded-2xl p-4 border border-white/10 relative overflow-hidden">
                ...
                <motion.div
                  ...
                  className="bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl p-3 flex items-center justify-between cursor-pointer transition-colors duration-200"
                >
                ...
                <div className="bg-white/5 rounded-2xl p-3 border border-white/10 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[8px] bg-emerald-500/20 text-success px-1.5 py-0.5 rounded font-bold">Local</span>
                  </div>
      ...
      <section id="features" className="relative z-10 py-20 bg-white border-y border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, i) => (
              <motion.article
                key={feature.id}
                className="bg-white rounded-3xl p-6 border border-border shadow-card flex flex-col justify-between h-full relative overflow-hidden group hover:border-primary/20"
              ...
              >
                <div>
                  <div
                    className="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl mb-5 shadow-sm"
      ...
      <section id="comparativa" className="relative z-10 py-20 bg-surface-2/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Table Container */}
          <div className="max-w-4xl mx-auto bg-white rounded-3xl border border-border shadow-card overflow-hidden">
      ...
      <section id="comunidad" className="relative z-10 py-20 bg-white border-y border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Target Card 1 */}
            <div className="bg-surface-2/40 rounded-3xl p-8 border border-border space-y-4 hover:bg-surface-2/70 transition-colors">
              <span className="text-3xl">🎓</span>
              <h3 className="font-syne font-bold text-xl text-text-primary">Estudiantes Universitarios</h3>
              <p className="font-dm text-sm text-text-secondary leading-relaxed">
            ...
            <div className="bg-surface-2/40 rounded-3xl p-8 border border-border space-y-4 hover:bg-surface-2/70 transition-colors">
              <span className="text-3xl">💼</span>
              <h3 className="font-syne font-bold text-xl text-text-primary">Freelancers / Profesionistas</h3>
              <p className="font-dm text-sm text-text-secondary leading-relaxed">
            ...
            <div className="bg-surface-2/40 rounded-3xl p-8 border border-border space-y-4 hover:bg-surface-2/70 transition-colors">
              <span className="text-3xl">👥</span>
              <h3 className="font-syne font-bold text-xl text-text-primary">Parejas y Amigos</h3>
              <p className="font-dm text-sm text-text-secondary leading-relaxed">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <div className="pt-2">
              <Button
                ...
                size="lg"
                onClick={handleStart}
                className="bg-white text-primary border-white hover:bg-surface-2 hover:text-primary font-syne font-bold shadow-md transform hover:scale-[1.02] transition-all"
              >
      ...
      {showInstallModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <motion.div
            ...
            className="bg-white rounded-3xl p-6 max-w-sm w-full border border-border shadow-blue-lg relative"
          >
            <button
